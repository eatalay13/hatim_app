...
const Footer: React.FC = () => {
  return (
    <div>
      <section
        className="py-20 bg-gradient-to-r from-emerald-600 to-emerald-800 text-white text-center bg-cover"
        style={{
      ...
      <footer
        className="bg-emerald-800 text-white py-10 w-full flex items-center justify-center bg-cover"
        style={{
